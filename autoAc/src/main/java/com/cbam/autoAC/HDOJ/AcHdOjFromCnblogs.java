...
public class AcHdOjFromCnblogs {
    ...
    public String getCodeHtml(String url) {
        ...
        HttpUtils.ResponseResult  rs = HttpUtils.getInstance()
                .addHeader("Host", "www.cnblogs.com")
                .addHeader("User-Agent","Mozilla/5.0 (Windows NT 6.3; WOW64; rv:50.0) Gecko/20100101 Firefox/50.0")
                .addHeader("Accept-Encoding","gzip, deflate")
    ...
    public String getCode(String html, int problem_id) {
        ...
        while(m.find()) {
            ...
            int y = m.group(1).toLowerCase().indexOf("hdu");
        ...
        int loc_start1 = html.indexOf("<pre>") + "<pre>".length();
    ...
    public static void main(String[] args) {
        ...
        for(int start = k; start <= m; start++) {
            try {
                ...
                String targetUrl = "http://cn.bing.com/search?q=hdu+"+ start +"+博客园&qs=n&form=QBRE&pq=hdu+"+ start + "+博客园&sc=1-9&sp=-1&sk=&cvid=B6CA7CF0A69C4B67906F6A4627C23BBF";
